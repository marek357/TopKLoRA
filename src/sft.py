...
def run_sft(cfg):
    ...
    if getattr(cfg.training.sft_dataset, "use_enhanced_datasets", False):
        ...
        train_dataset, eval_dataset = build_sft_datasets(
            ...
            dataset_weights=getattr(cfg.training.sft_dataset, "dataset_weights", None),
            mix_strategy=getattr(cfg.training.sft_dataset, "mix_strategy", "concat"),
            mix_seed=getattr(cfg.training.sft_dataset, "mix_seed", 42),
